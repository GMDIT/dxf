...
var _default = function _default(type, value, entity) {
  switch (type) {
    case 5:
      {
        return {
    ...
    case 1000:
      {
        if (entity) {
          ...
          if (entity.extendedData.value) entity.extendedData.value2 = value;else entity.extendedData.value = value;
          entity.extendedData.customStrings = entity.extendedData.customStrings || [];
          entity.extendedData.customStrings.push(value);
        }
        return {
          extendedData: (entity === null || entity === void 0 ? void 0 : entity.extendedData) || value
        };
      }
    case 1001:
      {
