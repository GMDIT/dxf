...
var text = function text(entity) {
  ...
  if (Math.sign(entity.y) > 0) _element = "<text x=\"".concat(entity.x, "\" y=\"").concat(entity.y, "\" class=\"standard\" font-family=\"Arial, sans-serif\" font-size=\"").concat(entity.textHeight + 0.1, "px\" stroke-width=\"0.01%\" fill=\"#696969\" transform=\"scale(1, -1) translate(0, -").concat(entity.y * 2, ")\"").concat(rotation, ">").concat(text, "</text>");else _element = "<text x=\"".concat(entity.x, "\" y=\"").concat(entity.y, "\" class=\"standard\" font-family=\"Arial, sans-serif\" font-size=\"").concat(entity.textHeight + 0.1, "px\" stroke-width=\"0.01%\" fill=\"#696969\" transform=\"scale(1, -1) translate(0, ").concat(entity.y * -2, ")\"").concat(rotation,">").concat(text, "</text>");
