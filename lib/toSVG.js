...
var text = function text(entity) {
  ...
  /* replace % symbol */
  text = text.replace('%%%', '%');
  if (Math.sign(entity.y) > 0) _element = "<text x=\"".concat(entity.x, "\" y=\"").concat(entity.y, "\" class=\"standard\" font-size=\"").concat(entity.textHeight + 0.1, "px\" stroke-width=\"0.01%\" fill=\"#696969\" transform=\"scale(1, -1) translate(0, -").concat(entity.y * 2, ")\">").concat(text, "</text>");else _element = "<text x=\"".concat(entity.x, "\" y=\"").concat(entity.y, "\" class=\"standard\" font-size=\"").concat(entity.textHeight + 0.1, "px\" stroke-width=\"0.01%\" fill=\"#696969\" transform=\"scale(1, -1) translate(0, ").concat(entity.y * -2, ")\">").concat(text, "</text>");
